...
parser.add_option("--jobdir", help="Job name for the output folder", dest="jobdir")
...
save_contacts(str_1, chains_1, cwd + "/" + out_folder + "/molecule_"+options.c1+".pdb")
save_contacts(str_2, chains_2, cwd + "/" + out_folder + "/molecule_"+options.c2+".pdb")

# save the interface residues
save_residues(cwd + "/" + out_folder + "/molecule_"+options.c1+".txt", interface_1, contacts_1)
save_residues(cwd + "/" + out_folder + "/molecule_"+options.c2+".txt", interface_2, contacts_2)
...
save_constrained(cwd + "/" + out_folder + "/molecule_"+options.c1+".pdb", cwd + "/" + out_folder + "/molecule_"+options.c1+"_constrained.pdb",
                 interface_1)
save_constrained(cwd + "/" + out_folder + "/molecule_"+options.c2+".pdb", cwd + "/" + out_folder + "/molecule_"+options.c2+"_constrained.pdb",
                 interface_2)
