...
def map_residue_variety_to_features(features,consurf_output_path,results_dir,pdb_id):
    ...
    # residue_variety_parsed_binned= consurf_output['residue_variety_parsed']
    val_dict = {aa:residue_variety_parsed_binned[:,i] for i,aa in enumerate(aa_letters)}
    consurf_output_with_binned_labels = consurf_output.assign(**val_dict)
